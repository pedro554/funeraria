...
from interface import janelaClientes, janelaFornecedores, janelaEstoque, janelaContratos, janelaPlanos
...
def Inicio(banco, cursor, path):
    ...
    menu_lateral = [
        ...
        [sg.Button('Planos', key='-PLANOS-', border_width=0, size=(20, 2), button_color='#666', font=('Consolas Bold', 12), mouseover_colors = ("#fff", "#333"))],
    ]
    ...
    while True:
        ...
        if event == '-PLANOS-':
            janelaPlanos.janelaPlanos(banco, cursor)
